...
4. Python Packages for Machine Learning
    ...
    - TensorFlow (building and training deep neural networks)
    - Keras - deep learning library that provides a user-friendly, high-level API for building and training neural networks
    - JAX (deep learning and scientific computing framework)
    - Natural Language Processing (NLP) - Hugging Face Transformers (It provides thousands of models for text, vision and audio, along with tools for fine-tuning, deployment and integration), NLTK
    - Computer Vision - OpenCV
    - Reinforcement Learning - Stable Baselines3 (PyTorch)
    - DeepSpeed - deep learning optimization library that makes training and inference of very large models (billions of parameters) efficient and cost-effective.
    - OpenVINO - Intel’s toolkit designed to optimize and deploy deep learning models for high-performance inference across edge devices, CPUs, GPUs and VPUs.
    - Amazon SageMaker AI (Build, Train, and Deploy Machine Learning Models and Algorithms at Scale.)
    - Seaborn
    - Matplotlib
    - Pandas
    - NumPy
  ...
  <tbody align="center">
    <tr>
      ...
      <td >
        ...
        <p>Several Python scripts written using arcpy module for the purpose of learning. It helps us the use of arcpy module.</p>
      </td>
    </tr>
  </tbody>
</table>
